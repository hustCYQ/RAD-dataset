...
We choose AUROC, Max-F1 and AP as metric for image-wise anomaly detection. We choose AUROC, Max-F1, AP and AUPRO as metric for pixel-wise anomaly detection. You can find the code for calculating these metrics in [eval_method.py](https://github.com/hustCYQ/RAD-dataset/blob/main/eval_method.py).
